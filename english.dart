final Map<String, String> english = {
  ...
  "setupTitle": "DigiID Setup:",
  "setupWarn":
      "It is very important to make sure you are in a secure place with no cameras or people watching before you continue.",
  "setupButtonCreate": "Create New Wallet",
  "setupButtonRecover": "Recover Wallet",

  "setupCreateTitle": "DigiID Wallet Creator",
  "setupCreateWarn":
      "Write on paper or punch in metal.\nDo not store electronically:",
  ...
  "setupSaveSetPin": "Set a pin:",
  "setupSaveSaving":  "Saving Seed",
  "setupSavePinNote": "*Numbers changed to prevent finger tracking.",
  ...
  "digiidConfirmWaiting": "Negotiating with site",
  "digiidConfirmBackupInstructions":
      "This is your backup password.\nDo not enter spaces.\n\n",

  "digipassTitle": "DigiPassword Generator",
  "digipassSiteHint": "Site Domain",
  "digipassInstructionAbove": "Enter domain above then enter pin:",
  "digipassInstructionBelow": "Enter domain below then enter pin:",
  "digipassNote":
      "*Based on your account seed and the input above this will generate a unique password for you.  If you input the same word or phrase a second time, the same password will be generated.",
...
//$enteredBitLength
  "warningShortMnemonic2":
      " bits. Mnemonic phrases shorter than 128 bit are not recommended.",

  "errorNoCamera": "No camera permission!",
